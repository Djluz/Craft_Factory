                            ...
                            <div class="product-cart-wrap mb-30">
                                ...
                                <div class="product-content-wrap">
                                    <div class="product-category">
                                        <a href="{{route('product.details',['slug'=>$item->model->slug])}}">{{$item->model->category->name}}</a>
                                    </div>
                                    ...
                                    <div class="product-price">
                                        <span><span>&#8369;</span>{{$item->model->sale_price}}</span>
                                        <span class="old-price"><span>&#8369;</span>{{$item->model->regular_price}}</span>
                                    </div>
                                    <div class="product-action-1 show">

                                        <a aria-label="Add To Cart" class="action-btn hover-up" href="#" wire:click.prevent="store({{$item->model->id}},'{{$item->model->name}}',{{$item->model->sale_price}})"><i class="fi-rs-shopping-bag-add"></i></a>
                                    </div>
                                </div>
                            </div>
                        </div>
