        ...
        <div class="cart-dropdown-wrap cart-dropdown-hm2">
                ...
                @foreach(Cart::instance('cart')->content() as $item)
                    <li>
                        ...
                        <div class="shopping-cart-title">
                            ...
                            <h4><span>{{$item->qty}} x </span><span>&#8369;</span>{{$item->model->sale_price}}</h4>
                        </div>
            ...
            <div class="shopping-cart-footer">
                <div class="shopping-cart-total">
                    <h4>Total  <span>P{{Cart::instance('cart')->total()}}</span></h4>
                </div>
                <div class="shopping-cart-button">
                    @if(Cart::instance('cart')->count() > 0)
                        <a href="{{route('shop.cart')}}" class="btn outline">View cart</a>
                        <a href="{{route('shop.checkout')}}" class="btn outline">CheckOut</a>
                    @endif
