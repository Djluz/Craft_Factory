                                    ...
                                    <div class="padding_eight_all bg-white">
                                        ...
                                        <form method="post" action="{{route ('login')}}">
                                            ...
                                            <div class="login_footer form-group">
                                                ...
                                                <a class="text-muted" id="linku" href="{{route('password.request') }}">Forgot password?</a>
                                            </div>
                                            <div class="form-group">
                                                <button type="submit" class="btn btn-fill-out btn-block hover-up fw-bold" href="{{route('verification.send') }}" name="login">Log in</button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
